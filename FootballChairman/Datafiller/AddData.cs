...
namespace FootballChairman.Datafiller
{
    public class AddData
    {
        ...
        private void CreateClubs()
        {
            ...
            _clubService.CreateClub(new Club { CountryId = 0, SkillDefense = random.Next(1, 99), SkillAttack = random.Next(1, 99), SkillMidfield = random.Next(1, 99), SkillGoalkeeping = random.Next(1, 99), Reputation = 5001, Id = 0, Name = "Union" });
            _clubService.CreateClub(new Club { CountryId = 0, SkillDefense = random.Next(1, 99), SkillAttack = random.Next(1, 99), SkillMidfield = random.Next(1, 99), SkillGoalkeeping = random.Next(1, 99), Reputation = 5001, Id = 1, Name = "Club Brugge" });
            _clubService.CreateClub(new Club { CountryId = 0, SkillDefense = random.Next(1, 99), SkillAttack = random.Next(1, 99), SkillMidfield = random.Next(1, 99), SkillGoalkeeping = random.Next(1, 99), Reputation = 5001, Id = 2, Name = "Antwerp" });
            _clubService.CreateClub(new Club { CountryId = 0, SkillDefense = random.Next(1, 99), SkillAttack = random.Next(1, 99), SkillMidfield = random.Next(1, 99), SkillGoalkeeping = random.Next(1, 99), Reputation = 5001, Id = 3, Name = "Anderlecht" });
            _clubService.CreateClub(new Club { CountryId = 0, SkillDefense = random.Next(1, 99), SkillAttack = random.Next(1, 99), SkillMidfield = random.Next(1, 99), SkillGoalkeeping = random.Next(1, 99), Reputation = 5001, Id = 4, Name = "AA Gent" });
